   ...
   <?php
     ...
     while($row=mysqli_fetch_row($res))
     {
	   ...
	   while($row1=mysqli_fetch_row($res1))
	   {
		   ?>
		   <tr>
	 <td><img src="<?php $row1[3];?>" width="100px" height="100px"></td>
		<td><?php print $row1[1];?></td>
		<td><?php print $row1[3];?></td>
		<td><?php print $row1[4];?></td>
		<td><?php print $row1[5];?></td>
	 ...
	 <td></td>
	 <td></td>
	 <td><a href="v_place_order?user_id=<?php print $user_id;?>"><button class="btn btn-succes">Place Order</button></a></td>
    </tr>
	</table>
