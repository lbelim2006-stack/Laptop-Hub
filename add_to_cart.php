...
{
	$q="INSERT INTO cart_master_tbl(prod_id,user_id,prod_qty,prod_price,total_price)VALUES($prod_id,$user_id,$prod_qty,$prod_price,$total_price)";
}
print $q;
...
if($res==1)
{
	header("location:r_cart_view.php?user_id=$user_id");
}
else
{
	print"not added";
